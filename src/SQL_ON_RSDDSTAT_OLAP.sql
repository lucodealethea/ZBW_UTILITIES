/* S/4 2020 does not seem to have CDS on RSDDSTAT_OLAP like BW/4 */
...
FROM CTE_RVIOLAPSTATA2
LEFT OUTER JOIN RSRTS_CDS_RPD AS RSZ ON RSZ.INFOCUBE = "CTE_RVIOLAPSTATA2"."INFOPROV"
...
SELECT * FROM cte_dist_data WHERE CALYEAR = '2023' ORDER BY TIMEOLAP DESC;
